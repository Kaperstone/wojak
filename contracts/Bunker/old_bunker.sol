...
contract Wojak is Ownable {
    ...
    // Community
    uint public BunkerPool = 0;

    // Treasury
    uint public BunkerBUSD = 0;

    // Just for LP counting
    ...
    function setVBUSDAddress(address newAddress) public onlyOwner {
    ...
    function setBondAddress(address newAddress) public onlyOwner {
