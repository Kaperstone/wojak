...
/** 
 *
 *  Wojak smart contract - Staking
 *  Here all the magic of the inflation happens
 *
**/
...
contract sWojak is ERC20, Ownable {
    ...
    constructor(address WojakTokenAddress) public ERC20("Staked Wojak", "stakedWJK", 18) { 
