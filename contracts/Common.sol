...
contract Common is AccessControl {
    ...
    bytes32 public constant TSTRATEGY_ROLE = keccak256("TSTRATEGY_ROLE");
    ...
    function setAddressToken(address newAddress) public onlyRole(DEFAULT_ADMIN_ROLE) {
        ...
        grantRole(TOKEN_ROLE, newAddress);
    }
    ...
    function setAddressStaking(address newAddress) public onlyRole(DEFAULT_ADMIN_ROLE) {
        ...
        grantRole(STAKING_ROLE, newAddress);
    }
    ...
    function setAddressSoyFarm(address newAddress) public onlyRole(DEFAULT_ADMIN_ROLE) {
        ...
        grantRole(SOYFARMS_ROLE, newAddress);
    }
    ...
    constructor() {
        ...
        _setupRole(TSTRATEGY_ROLE, msg.sender);
